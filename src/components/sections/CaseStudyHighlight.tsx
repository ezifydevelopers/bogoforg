  ...
  return (
    <section className="relative overflow-hidden bg-white py-20 dark:bg-[#0B0C10] transition-colors duration-300">
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          <span className="mb-4 inline-block rounded-full border-2 border-primary bg-primary px-4 py-1 text-sm font-medium text-white">
            Featured Case Study
          </span>
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <motion.div
            ...
            className="relative h-96 overflow-hidden rounded-2xl lg:h-full group"
          >
            <ImageReveal
